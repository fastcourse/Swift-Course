...
override func viewDidLoad() {
  ...
  //load img into alert
func Show_nafida_for_msgsOK4(x: Int){
        ...
        let alert = UIAlertController(title: "Unfollow John Doe?", message: alert_msg, preferredStyle: .actionSheet)
        ...
        let url = URL(string: sender_img_path)!
            ...
            if let data = try? Data(contentsOf: url) {
             ...
             image = UIImage(named: "galury_2_36")
        }
